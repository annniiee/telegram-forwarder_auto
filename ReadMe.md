...
- Make a <code>.env</code> file in the root of the repo, like <a href="https://github.com/annniiee/telegram-forwarder_auto">.env.sample</a> and fill in the values.</br>
